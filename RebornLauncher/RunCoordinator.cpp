...
RunCoordinator::RunCoordinator(LauncherUpdateCoordinator& worker)
	: m_worker(worker) {
}

DWORD RunCoordinator::Execute() {
...
bool RunCoordinator::FailWithMessage(const wchar_t* message) const {
