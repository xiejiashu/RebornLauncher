...
1. `RebornLauncher/WorkThread.cpp` - 470
...
8. `RebornLauncher/WorkThreadResumeDownload.cpp` - 47
9. `RebornLauncher/LauncherSplashRenderer.cpp` - 42
10. `RebornLauncher/WorkThreadManifest.cpp` - 39
